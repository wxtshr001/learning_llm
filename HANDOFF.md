...
- 第 0004 课最终 97/100 并正式通过。脚本复跑全部检查通过；两处不改变推理链的抄写笔误仅轻微扣分，不安排补强。第 0005 课已生成，等待提交。
...
遵守 `AGENTS.md`，先拉取 `main`。读取 0004 最终反馈与 0005 材料；收到 0005 后检查 RMSNorm 手算、last-axis reduction/broadcasting、Linear `[out,in]`、gated FFN shape 与逐元素门控，未通过独立作业或关键题 1、3 时不得生成第 0006 课。
