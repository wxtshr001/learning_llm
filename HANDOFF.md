...
- 第 0003 课最终裁决 92/100 并正式通过。初次评分错误增加了题面未声明的 dtype 条件，已按学习者异议更正并撤销 0003R。第 0004 课已生成，等待提交。
...
遵守 `AGENTS.md`，先拉取 `main`。读取 0003 最终反馈与 0004 材料；收到 0004 后检查 Module/Parameter 注册、手算梯度、forward/backward/optimizer 职责、finite difference 与推理模式，未通过关键题时不得生成第 0005 课。
